#!/usr/bin/env python3
"""
LFUCache is a class that inherits from BaseCaching and is a caching system:
"""
...
class LFUCache(BaseCaching):
    ...
    """
    def __init__(self):
        """This function initializes must use self.cache_data - dictionary from
    ...
    def __reorder_items(self, mru_key):
        """This function reorders the items in this cache based on the most
        recently used item.
        """
        max_positions = []
        mru_freq = 0
